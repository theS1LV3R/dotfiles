# Generated by Powerlevel10k configuration wizard on 2023-04-30 at 21:26 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(gpd|wg|(.*tun)|tailscale)[0-9]*|(zt.*)|(machina)'
